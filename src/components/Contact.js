  ...
  return (
    <section id="contact" className="bg-black text-white p-5">
      <div className="flex flex-col justify-center items-center py-32">
        ...
        <form id="contactForm" className='my-11 min-h-96 p-2 lg:p-5 w-full lg:w-2/5 bg-zinc-900 rounded-lg flex flex-col items-center' onSubmit={handleSubmit}>
            <label htmlFor="" className='my-2'>Nom</label>
            <input name="name" placeholder="John" className="text-white bg-black min-h-12 p-3 rounded-lg w-3/4"></input>
            <label htmlFor="" className='my-2'>Email</label>
            <input name="email" placeholder="example@gmail.com" className="text-white bg-black min-h-12 p-3 rounded-lg w-3/4">
            </input>
